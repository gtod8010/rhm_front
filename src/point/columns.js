const columns = [
  { field: 'date', headerName: '포인트 발급/회수일', flex: 1, align: 'center', headerAlign: 'center', type: 'date', headerClassName: 'super-app-theme--header',
  renderCell: (params) => {
    const date = new Date(params.value);
    return date.toLocaleString(); // 날짜와 시간을 로컬 형식으로 표시
  }
},
    { field: 'id', headerName: '발급 ID', flex: 0.5 ,align: 'center', headerAlign: 'center', headerClassName: 'super-app-theme--header'},
    ...
    { field: 'point', headerName: '포인트', flex: 0.5, align: 'center', headerAlign: 'center', headerClassName: 'super-app-theme--header' },
